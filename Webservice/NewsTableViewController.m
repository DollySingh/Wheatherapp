...
- (void)viewDidLoad {
    ...
    NSString *url=@"http://api.openweathermap.org/data/2.5/forecast?lat=35&lon=139&appid=2de406b85e520c5732f8da78d61b569f";
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
  ...
  NSArray *innerarray=  [outerdic objectForKey:@"list"];
    
    for(NSDictionary *temp in innerarray)
    {
        NSArray *weatherArray = [temp objectForKey:@"weather"];
            
        for (NSDictionary *weatherDicTemp in weatherArray)
        {
                    
         NSString *str= [weatherDicTemp objectForKey:@"description"];
